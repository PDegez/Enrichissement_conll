        ...
        for id_token in sentence_nodes:
            ...
            if sentence_nodes[id_token]["FEATS"].get("PronType") == "Rel":
                if int(sentence_nodes[id_token]["MISC"].get("HUM_SCORE", 0)):
                    ...
                    if id_antecedent:
                        data[index_sentence]["treeJson"]["nodesJson"][id_antecedent]["MISC"]["HUM_SCORE"] = int(data[index_sentence]["treeJson"]["nodesJson"][id_antecedent]["MISC"].get("HUM_SCORE", 0))+ 70
                        # print(index_sentence)
                        # print(sentence_nodes[id_token]["LEMMA"])
        ...
        for id_token in sentence_nodes:
            ...
            if sentence_nodes[id_token]["DEPREL"] == "conj:coord":
                ...
                if sentence_nodes[id_token]["UPOS"] in ["NOUN", "PROPN", "PRON"]:
                    ...
                    if score:
                        data[index_sentence]["treeJson"]["nodesJson"][id_token]["MISC"]["HUM_SCORE"] = int(data[index_sentence]["treeJson"]["nodesJson"][id_token]["MISC"].get("HUM_SCORE", 0))+ 10
                        print(data[index_sentence]["treeJson"]["nodesJson"][id_token]["LEMMA"])
                        print(data[index_sentence]["metaJson"]["sent_id"])
        ...
        for id_token in sentence_nodes:
                ...
                if sentence_nodes[id_token]["UPOS"] == "VERB":
                    ...
                    if id_subj:
                        ...
                        data[index_sentence]["treeJson"]["nodesJson"][id_subj]["MISC"]["HUM_SCORE"] = score + 20
                            # print(data[index_sentence]["treeJson"]["nodesJson"][id_subj]["LEMMA"])
                            # print(data[index_sentence]["metaJson"]["sent_id"])                       
                    ...
                    for token_arg in sentence_nodes:
                        if str(sentence_nodes[token_arg]["HEAD"]) ==  str(sentence_nodes[id_token]["HEAD"]):
                            if str(sentence_nodes[token_arg]["DEPREL"]) == "subj":
                                data[index_sentence]["treeJson"]["nodesJson"][token_arg]["MISC"]["HUM_SCORE"] = int(data[index_sentence]["treeJson"]["nodesJson"][token_arg]["MISC"].get("HUM_SCORE", 0)) + 40
    #                                 print(data[index_sentence]["treeJson"]["nodesJson"][token_arg]["LEMMA"])
    #                                 print(data[index_sentence]["metaJson"]["sent_id"])
    #                                 nb_pred += 1
    # print(nb_pred)
            ...
            if sentence_nodes[id_token]["FEATS"].get("PronType") == "Rel":
                ...
                if int(sentence_nodes[id_token]["MISC"].get("HUM_SCORE", 0)):
                    ...
                    if id_antecedent:
                        ...
                        if score < 70:
                                data[index_sentence]["treeJson"]["nodesJson"][id_antecedent]["MISC"]["HUM_SCORE"] = int(data[index_sentence]["treeJson"]["nodesJson"][id_antecedent]["MISC"].get("HUM_SCORE", 0))+ 70
                        # print(data[index_sentence]["treeJson"]["nodesJson"][id_antecedent]["LEMMA"])
                        
        sentences_json.append(data[index_sentence])
                
            # if int(data[index_sentence]["treeJson"]["nodesJson"][id_token]["MISC"].get("HUM_SCORE",0)) >= 8:
            #     print("yolo")
